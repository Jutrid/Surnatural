...
from .models import Services, Commentaires, Publicites, Publications, Reactions, Likes, Pub_Videos
...
class Pub_VideosAdmin(admin.ModelAdmin):
    list_display = ('id', 'label', 'video')
...
admin.site.register(Pub_Videos, Pub_VideosAdmin)
