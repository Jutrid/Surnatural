...
from .models import Pub_Videos, Services, Commentaires, Publicites, Publications, Reactions, Likes
...
def work(request):
    video = Pub_Videos.objects.get(id=2)
    ...
    if request.user.is_authenticated:
        ...
        return render(request, 'application/work.html', context={'data':services, 'p1':p1, 'p2':p2, 'p3':p3, 'p4':p4, 'p5':p5, 'p6':p6, 'n1':nb_like[0], 'n2':nb_like[1], 'n3':nb_like[2], 'n3':nb_like[2], 'n3':nb_like[2], 'n4':nb_like[3], 'n5':nb_like[4], 'n6':nb_like[5], 'l1': l1, 'l2':l2, 'l3':l3, 'l4':l4, 'l5':l5, 'l6':l6, 'video':video}) #
    else:
        return render(request, 'application/work2.html', context={'data':services, 'publications':publications, 'video':video})
